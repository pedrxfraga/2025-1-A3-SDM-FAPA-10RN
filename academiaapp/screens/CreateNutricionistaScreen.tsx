...
type Props = DrawerScreenProps<DrawerParamList, 'CreateNutricionista'>;

const CreateNutricionistaScreen = ({ navigation }: Props) => {
  ...
  const handleSave = async () => {
    setSaving(true);
    await fetch('http://localhost:8000/nutricionista/', {
      method: 'POST',
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Novo Nutricionista</Text>
...
export default CreateNutricionistaScreen;